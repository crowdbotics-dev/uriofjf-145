"""
Django settings for uriofjf_145 project.
...
WSGI_APPLICATION = 'uriofjf_145.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uriofjf_145 API",
    "DESCRIPTION": "API documentation for uriofjf_145 App",
    "VERSION": "v1",
}
